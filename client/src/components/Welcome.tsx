...
const Input: FC<{
  ...
  type: string;
  value: string;
  handleChange: (v: string, n: string) => void;
  ...
  return (
    <div className="flex w-full justify-center items-center">
      <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
        <div className="flex flex-1 justify-start flex-col mf:mr-80">
          ...
          <div className="grid sm:grid-cols-3 grid-cols-2 w-full mt-10">
            ...
            <div className={`rounded-tr-xl ${commonStyles}`}>Etherium</div>
            <div className={`rounded-bl-xl ${commonStyles}`}>web 3.0</div>
            <div className={commonStyles}>Low fees</div>
            <div className={`rounded-br-xl ${commonStyles}`}>Blochchain</div>
          </div>
        </div>
